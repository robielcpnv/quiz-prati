...
import 'package:quiz/services/remote_question_repository.dart';
...
class MenuPage extends StatelessWidget {
  //final _questionRepository = RemoteQuestionRepository(Uri.parse("http://10.0.2.2:4567/questions/next"));
        ...
        child: Column(
          ...
          children: [
            ElevatedButton(
              ...
              child: const Text("Rookie", textScaleFactor: 2.0, textAlign: TextAlign.center),
            ),
            ElevatedButton(
              onPressed: () {
                Navigator.pushReplacement(context, MaterialPageRoute(
              ...
              child: const Text("Journeyman", textScaleFactor: 2.0, textAlign: TextAlign.center),
            ),
            ElevatedButton(
              onPressed: () {
                Navigator.pushReplacement(context, MaterialPageRoute(
              ...
              child: const Text("Warrior", textScaleFactor: 2.0, textAlign: TextAlign.center),
            ),
            ElevatedButton(
              onPressed: () {
                Navigator.pushReplacement(context, MaterialPageRoute(
              ...
              child: const Text("Ninja", textScaleFactor: 2.0, textAlign: TextAlign.center),
            ),
          ],
        ),
      )
