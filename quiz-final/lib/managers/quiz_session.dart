...
abstract class QuizSession with ChangeNotifier implements ValueListenable<QuizSession> {
  ...
  QuizSession({required QuestionRepository questionRepository, required int totalQuestionCount}) {
  ...
  void $stop() {
    NavigationManager.instance.navigateToReplacement(MaterialPageRoute(builder: (context) => const GameoverPage()));
  }
}
