...
class WarriorQuizSession extends JourneymanQuizSession {
  ...
  WarriorQuizSession({required QuestionRepository questionRepository, totalQuestionCount = 15}) : super(questionRepository: questionRepository, totalQuestionCount: totalQuestionCount) {
